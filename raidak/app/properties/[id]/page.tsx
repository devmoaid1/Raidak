...
export default function PropertyDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!property) {
    return (
      <div className="flex flex-col items-center justify-center min-vh-100 p-8">
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12 space-y-12 text-right">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-12">
            ...
            <Card className="border-none shadow-xl bg-slate-50 overflow-hidden rounded-[2rem]">
              <CardContent className="p-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className={`px-8 py-6 rounded-[2rem] border-2 flex items-center justify-center gap-4 transition-all hover:scale-105 ${gauge.bgColor} ${gauge.color} border-current/10 order-2 md:order-1`}>
                  ...
                  <div className="space-y-2 text-center md:text-right order-1 md:order-2">
                ...
                <div className="mt-8 p-4 bg-white rounded-2xl border border-slate-100 flex items-start justify-end gap-3 text-right">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-8 bg-green-50 rounded-[2.5rem] border border-green-100 flex flex-col justify-between h-64 group hover:bg-green-100/50 transition-colors text-right">
              ...
              <div className="p-8 bg-blue-50 rounded-[2.5rem] border border-blue-100 flex flex-col justify-between h-64 group hover:bg-blue-100/50 transition-colors text-right">
                <div className="flex items-center justify-between">
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div className="size-8 rounded-full bg-white flex items-center justify-center text-blue-300 cursor-pointer">
        ...
        <div className="space-y-8">
          <Card className="border-none shadow-2xl rounded-[2.5rem] overflow-hidden sticky top-24 text-right">
