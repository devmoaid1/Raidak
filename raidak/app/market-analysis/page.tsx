    ...
    <div className="container mx-auto px-4 py-12 space-y-12">
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-xl text-muted-foreground">
          استكشف الاتجاهات السوقية والبيانات الضخمة للعقارات في كافة مناطق
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="border-none shadow-xl bg-gradient-to-br from-primary to-primary/80 text-white">
          ...
          <CardContent>
            <p className="text-primary-foreground/80 mb-6">
              نمو مستمر في القطاع السكني والتجاري بمتوسط 12% سنوياً.
            </p>
        ...
        <Card className="border-none shadow-xl bg-white">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              تغطية ذكية لأكثر من 100 حي في المدن الكبرى (جدة، الدمام، مكة).
            </p>
        ...
        <Card className="border-none shadow-xl bg-white">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              نعتمد في تحليلاتنا على البيانات الرسمية من إيجار والبورصة العقارية
              السعودية.
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="border-none shadow-2xl bg-white overflow-hidden">
        <div className="p-12 text-center space-y-6">
          ...
          <h2 className="text-3xl font-heading font-black text-primary">
            قريباً: لوحات بيانات تفاعلية
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            نحن نعمل على تطوير خرائط حرارية وتحليلات متقدمة لتمكينك من اتخاذ
            قرارات استثمارية مبنية على البيانات.
          </p>
        </div>
      </Card>
    </div>
